INSERT INTO categorias (id_categoria, descripcion, estado) VALUES (1, 'Comida', 1);
INSERT INTO categorias (id_categoria, descripcion, estado) VALUES (2, 'Ropa', 1);
INSERT INTO categorias (id_categoria, descripcion, estado) VALUES (3, 'Accesorios', 1);
...
VALUES (1, 'C001', '2024-07-01 14:30:00', 'T', 'realizada', 'A');
INSERT INTO compras (id_compra, id_cliente, fecha, medio_pago, comentario, estado) 
VALUES (2, 'C002', '2024-07-02 09:15:00', 'E', 'entregado', 'P');
INSERT INTO compras (id_compra, id_cliente, fecha, medio_pago, comentario, estado) 
VALUES (3, 'C003', '2024-07-03 16:45:00', 'T', 'espera', 'E');

INSERT INTO productos (id_producto, nombre, id_categoria, codigo_barras, precio_venta, cantidad_stock, estado) 
VALUES (1, 'Hamburguesa X', 1, '1234567890123', 499.99, 50, 1);
INSERT INTO productos (id_producto, nombre, id_categoria, codigo_barras, precio_venta, cantidad_stock, estado) 
VALUES (2, 'Camisa', 2, '2345678901234', 29.99, 100, 1);
INSERT INTO productos (id_producto, nombre, id_categoria, codigo_barras, precio_venta, cantidad_stock, estado) 
VALUES (3, 'Collar', 3, '3456789012345', 799.99, 10, 1);
